...
func (c *toSuiService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *toSuiHandler) Call(ctx context.Context, in *Request, out *Response) error {
